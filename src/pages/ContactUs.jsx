    ...
    <div className="min-h-screen">
      ...
      <div className="relative overflow-hidden ">
        ...
        >
          ...
          <div className="pt-20 bg-card/30">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-20 max-w-5xl mx-auto items-center bg-card/50">
              {/* <ContactForm /> */}

              <div
                className={`hs-form-frame`}
                data-region="na2"
                data-form-id="84b62d3b-b4ed-4ce1-94e6-0169b86a335e"
                data-portal-id="244306063"
              />

              <div className="w-full h-full py-10 overflow-hidden px-8 md:px-4  mt-8 space-y-10">
              ...
              <Separator className="my-2"/>
                  <div className="flex flex-col items-start gap-4 mt-4 pointer-events-auto">
                    ...
                    <a
                      ...
                      className="flex flex-row items-center gap-2 font-body text-accent text-small underline font-bold"
                    >
                      <FaWhatsapp size={18} />
                      Connect on WhatsApp
                    </a>
            ...
            >
              <div className="flex flex-col max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 justify-center items-center gap-12 ">
                ...
                <Accordion
                  type="single"
                  className="w-full md:w-[900px] pb-20 h-full md:h-[800px]"
                  collapsible
                >
                  {faqs.map((item, index) => {
                    return (
                      ...
                      >
                        <AccordionTrigger className="font-body text-[16px] text-heading font-medium hover:text-accent">
                          {item.question}
                        </AccordionTrigger>
