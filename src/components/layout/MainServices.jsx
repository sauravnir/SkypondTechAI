        ...
        >
          <div className="flex flex-row mt-8  p-6 rounded-xl ">
            <Tabs value={services[activeIndex].id} className="w-full">
              <TabsList
                className="flex gap-0 py-8 w-full overflow-x-auto md:overflow-visible
    md:justify-center max-w-full  md:max-w-5xl mx-auto rounded-2xl bg-muted/10 shadow-xl scrollabar-hidden"
              >
